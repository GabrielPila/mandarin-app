...
export const ALL = [];
B1_VOCAB.forEach((e, i) => { e.id = 'b1:' + i; e.book = 1; ALL.push(e); });
B1_SUP.forEach((e, i) => { e.id = 'b1s:' + i; e.book = 1; ALL.push(e); });
B2_VOCAB.forEach((e, i) => { e.id = 'b2:' + i; e.book = 2; ALL.push(e); });
B2_SUP.forEach((e, i) => { e.id = 'b2s:' + i; e.book = 2; ALL.push(e); });
